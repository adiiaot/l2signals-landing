    ...
    <div className="max-w-3xl mx-auto px-3 sm:px-4 py-6 sm:py-8">
      <div className="card">
        ...
        <div className="prose prose-sm max-w-none mt-4 sm:mt-6 space-y-4 sm:space-y-5 text-xs sm:text-[13px] leading-relaxed text-text-secondary break-words">
          ...
          <section><h2 className="text-sm font-bold text-text-primary">3. Services, quotes & payments</h2><ul className="list-disc ml-4 space-y-1"><li>Signals memberships (if offered) are priced in-channel. All services work (API access, trading systems, apps, partnerships) is quoted custom per engagement — no fixed prices on this site.</li><li>Work starts from a written scope (what ships, timeline, payment terms). Payment terms are set in that scope.</li><li>Manual payments (bank / crypto) require admin approval — access granted after confirmation. Activation codes are non-transferable.</li><li>Refunds are handled case-by-case unless a written scope guarantees otherwise.</li></ul></section>
