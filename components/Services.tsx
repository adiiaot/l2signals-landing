    ...
    <section id="services" className="max-w-6xl mx-auto px-4 py-6 scroll-reveal">
      <div className="card">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3 mt-4 text-xs">
          ...
          <a href="/services#hire" className="rounded-xl p-3 hover:border-accent-gold transition" style={{ background: 'rgb(var(--surface-overlay-rgb))', border: '1px solid var(--glass-border)' }}><p className="font-semibold">Hire & partnerships</p><p className="text-text-muted mt-1">Work with the team, not just the product.</p></a>
        </div>
